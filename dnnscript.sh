...
for hmm in  hmm84
	...
	for file in MFC_E_D_A_Z_Init20  FBK_D_A_Z_Init20 
	do	
	echo $hmm ${file} -CS 4 -H $H -N $N >> dnntraintri.txt
	...
	grep -A2 -P 'SENT' MHO/decode-tri-dnn${dnnft}.finetune/$hmm/${file}_${H}H_CS4_N${N}/test/LOG >> dnntesttri.txt
...
#In progress #TODO check if done properly
for N in 500
do
for i in 3 5 7
do
